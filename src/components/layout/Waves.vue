<template>
    <div class="waves">
        <svg
                ...
                x="0px"
                y="0px"
                viewBox="0 0 275 223.7"
                style="enable-background:new 0 0 275 223.7;"
                xml:space="preserve"
        >
          <linearGradient
                  id="SVGID_1_"
          ...
          >
            ...
            <path
                    class="st0"
                    d="M258.3,68c-21.8-6.7-21.5-47.8-31-48.3c-15.4-0.9-26.7,107.3-47.7,108c-16.6,
            0.6-26.8-67-46.7-66.3 c-14.7,0.5-20,37.9-31.3,37.3c-18.2-0.9-24-98.7-36-98.7C54.7,
            0,49.5,82,36,82.3C25.4,82.6,18,32.1,8.3,33C3.2,33.5,0.7,47.8,0,51.7v172h275v-158C270.3,67.9,265,70,258.3,68z"
            />
            <linearGradient
                    id="SVGID_2_"
                    gradientUnits="userSpaceOnUse"
            ...
            <path
                    class="st1"
                    d="M261.8,94.7c-19.3,3.2-28.2-24.1-48.5-24.3c-22.5-0.2-29.2,33.3-47.3,32.2c-24.6-1.5-32.5-64.7-52-64.2
          ...
          C271.7,90.5,267.5,93.7,261.8,94.7z"
            ...
            <stop
                    offset="3.960396e-02"
                    style="stop-color:#33D4FA;stop-opacity:0"
            />
                <stop offset="1" style="stop-color:#00B2FA" />
          </linearGradient>
            <path
                    class="st2"
                    d="M275,223.7V87.8c-6.2,4.4-15.4,9.1-26,8.9c-29.2-0.7-36.9-39.1-61.2-38.7c-22.1,0.4-29.1,32.4-46,30.3
